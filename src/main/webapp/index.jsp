    ...
    <style>
        ...
        * {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 8px 24px rgba(217, 93, 59, 0.30);
        }
        .btn-secondary {
        ...
        .btn-secondary:hover {
            ...
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(15, 15, 26, 0.20);
        }
        .btn-outline {
        ...
        header {
            ...
            border-bottom: 1px solid rgba(15, 15, 26, 0.04);
        }
        .header-inner {
            display: flex;
            align-items: center;
        ...
        .search-wrap:focus-within {
            border-color: var(--accent);
            background: #fff;
            box-shadow: 0 0 0 4px rgba(217, 93, 59, 0.10);
        }
        .search-wrap input {
            border: 0;
            background: transparent;
        ...
        #mobileMenu {
            display: none;
            background: #fff;
            border-top: 1px solid rgba(15, 15, 26, 0.04);
            padding: 12px 0 20px;
        }
        #mobileMenu ul {
            list-style: none;
        ...
        .hero {
            ...
            overflow: hidden;
            margin: 20px 24px 0;
            background: linear-gradient(135deg, #0f0f1a 0%, #1f1f2e 100%);
        }
        .hero::before {
            content: '';
            position: absolute;
        ...
        .hero .badge {
            ...
            background: rgba(217, 93, 59, 0.18);
            color: var(--accent);
            padding: 4px 16px;
            border-radius: 999px;
            font-weight: 600;
        ...
        <div class="container header-inner">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                <div class="search-wrap" role="search">
                    ...
                    <button id="searchBtn" aria-label="Submit search"><i class="fas fa-search
